...
abstract class $MainStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({int index, bool isError});
}
...
class _$_MainState extends _MainState {
  _$_MainState({required this.index, required this.isError}) : super._();
  ...
  @override
  String toString() {
    return 'MainState(index: $index, isError: $isError)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, index, isError);
...
abstract class _MainState extends MainState {
  factory _MainState({required final int index, required final bool isError}) =
      _$_MainState;
